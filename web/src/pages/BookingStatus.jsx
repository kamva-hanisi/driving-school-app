    ...
    <main className="booking-page booking-status-page">
      <section className="booking-card booking-status-card">
        ...
        <p className="booking-card__text">
          Your booking status updates here when the driving school confirms your lesson.
        </p>
              ...
              <div className="booking-detail booking-detail--wide">
                ...
                <strong>
                  {booking.status === "confirmed"
                    ? "Confirmed means your booking has been approved by the driving school."
                    : "Pending means the driving school has received your booking and has not confirmed it yet."}
                </strong>
              </div>
            </div>
          </div>
